...
- Bring your design to life with dynamic SplitText reveals, smooth parallax scrolling, and scroll-triggered effects using GSAP’s ScrollTrigger.
- Lock sections in place with pinned animations, sync video playback to scroll position for cinematic storytelling, and enhance visual impact with scroll-based image masking.
- A custom animated carousel, craft seamless timeline animations across sections, and a fully responsive UI that adapts beautifully across all screen sizes.
...
```bash
git clone https://github.com/OmkeshJadhav/mojito-cocktails.git
cd gsap_cocktails
```
